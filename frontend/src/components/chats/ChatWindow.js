...
const ChatWindow = ({ selectedChat }) => {
  return (
    <div className="flex flex-col flex-grow h-[calc(100vh-56px)] bg-gray-50">
      {!selectedChat ? (
        ...
        <>
          {/* Chat Header */}
          <div className="bg-gray-200 p-3 text-lg font-semibold border-b">{selectedChat.name}</div>
          ...
          <div className="flex items-center p-3 border-t bg-white">
            ...
            <input type="text" className="flex-grow mx-3 p-2 border rounded-lg outline-none" placeholder="Type a message..." />
